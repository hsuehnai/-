...
<body>
	...
	<div id="employee" class="container tab-pane fade"><br>
      	<h3>員工註冊</h3>
	<div class="container">
        <form id="form_employee" name="form_employee" method="get" action="./employee_register_check.php">
            <div>
                <h5>員工資料設定</h5>
	...
	<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <form id="form_customer" name="form_customer" method="get" action="./cust_register_check.php">
			            ...
			            <div class="mb-3">
                            <label for="pw1" class="form-label"><b>請輸入密碼</b></label>
                            <input 
                            id="pw1" 
                            type="password" 
                            name="pw1"
			            ...
			            <div class="mb-3">
                            <label for="pw2" class="form-label"><b>請確認密碼</b></label>
                            <input 
                            id="pw2" 
                            type="password" 
                            name="pw2"
